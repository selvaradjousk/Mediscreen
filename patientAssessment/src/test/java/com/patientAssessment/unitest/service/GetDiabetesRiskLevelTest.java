...
//        when(assessmentService.getAge(patientDTO.getBirthDate())).thenReturn(54);
	...
	@DisplayName("getDiabetesRiskLevel: ReesAsXXX - "
			+ "GIVEN a patient Rees "
			+ "WHEN getDiabetesRiskLevel"
			+ "THEN returns expected DiabetesRiskLevel of the Rees As xxxx")
    @Test
    public void GetDiabetesRiskLevelForReesAsXXTest() {
